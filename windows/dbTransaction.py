...
class dbTransactions:
    ...
    def createTables(self):
        ...
        # Araç Tablosu
        mycursor.execute("CREATE TABLE IF NOT EXISTS araclar (arac_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, arac_tur VARCHAR(50) NOT NULL, arac_model VARCHAR(50) NOT NULL, arac_uretim_yili YEAR NOT NULL, arac_yakit_tur VARCHAR(30) NOT NULL, arac_vites VARCHAR(10) NOT NULL, arac_motor_gucu VARCHAR(20) NOT NULL, arac_kasa_tip VARCHAR(20) NOT NULL, arac_motor_hacim VARCHAR(50) NOT NULL, arac_cekis VARCHAR(20) NOT NULL, arac_kapi VARCHAR(15) NOT NULL, arac_renk VARCHAR(50) NOT NULL, arac_motor_no VARCHAR(11) NOT NULL UNIQUE, arac_sasi_no VARCHAR(11) NOT NULL UNIQUE, arac_kiralama_bedeli_gunluk SMALLINT NOT NULL, arac_kira_durumu VARCHAR(15) NOT NULL, arac_kullanim_durumu VARCHAR(15) NOT NULL)")
